        ...
        this.model = [
            {
                ...
                items: [
                    ...
                    // { label: 'CO\u2082', icon: 'pi pi-fw pi-chart-bar', routerLink: ['/co2'] },
                    // { label: 'Customer Count', icon: 'pi pi-fw pi-chart-bar', routerLink: ['/count'] },
                    // { label: 'Contact', icon: 'pi pi-fw pi-id-card', routerLink: ['/uikit/misc'] },
                    // { label: 'Service & Report', icon: 'pi pi-fw pi-file', routerLink: ['utilities/icons'] }
                ]
            },
            // {
