...
@Component({
  selector: 'app-temp-chart-current-sensor',
  templateUrl: './temp-chart-current-sensor.component.html',
  styleUrls: ['./temp-chart-current-sensor.component.scss']
})
export class TempChartCurrentSensorComponent implements OnInit {
  ...
  tempChartCurrentData: any;
  optionsBarChartCurrentTemp: any;
  ...
  ngOnInit(): void {
    ...
    this.tempChartCurrentData = [{
      type: 'temp',
      typeChartName: 'Current Temperature Sensors.',
      check: [1],
      chartShow: true,
      dataSensors: [{
        zoneID: 'a',
        zoneName: 'Building Zone A',
        data: {
          labels: ['Temp. Sensor 01', 'Temp. Sensor 03', 'Temp. Sensor 04', 'Temp. Sensor 06'],
          datasets: [{
            label: 'My First dataset',
            backgroundColor: this.chartBGColor,
            borderColor: this.chartBorderColor,
            data: [22.9, 23.9, 21.9, 23.9],
            fill: false,
            tension: 0,
            yAxisID: 'left-y-axis'
          }]
        ...
        zoneName: 'Building Zone B',
        data: {
          labels: ['Temp. Sensor 02', 'Temp. Sensor 05'],
          datasets: [{
            label: 'My First dataset',
            backgroundColor: this.chartBGColor,
            borderColor: this.chartBorderColor,
        ...
        data: {
          labels: ['Temp. Sensor 07', 'Temp. Sensor 08', 'Temp. Sensor 09'],
          datasets: [{
            label: 'My First dataset',
            backgroundColor: this.chartBGColor,
            borderColor: this.chartBorderColor,
      ...
      data: {
        labels: ['Temp. Sensor 02', 'Temp. Sensor 05', 'Temp. Sensor 04', 'Temp. Sensor 06'],
        datasets: [{
          label: 'My First dataset',
          backgroundColor: this.chartBGColor,
          borderColor: this.chartBorderColor,
          data: [24.5, 24.8, 25.2, 24.5],
          fill: false,
          tension: 0,
          yAxisID: 'left-y-axis'
        }]
      ...
      // }, {
      //   type: 'humidity',
      //   typeChartName: 'Humidity Sensor.',
      //   check: [1],
      //   zoneNameList: ['Building Zone A', 'Building Zone B'],
      //   chartShow: true,
      //   dataSensors: [{
      //     zoneID: 'A',
      //     zoneName: 'Building Zone A'
    ...
    // Option Line Chart
    this.optionsBarChartCurrentTemp = {
      type: 'bar',
      legend: {
        display: false,
        responsive: true,
      ...
      title: {
        display: false,
        text: 'Current Temperature Sensor Chart'
      },
      scales: {
        yAxes: [{
          id: 'left-y-axis',
  ...
  //   if ($event.currentTarget.value != this.selectedSensorType) {
  //     this.selectedSensorType = $event.currentTarget.value;
  //   }
  // }


  // getViewChart($event: any, zoneID) {
  //   // console.log(zoneID);
  //   // console.log($event);

  //   if (this.selectedZoneViewID != zoneID) {
  //     this.selectedZoneViewID = zoneID;
  //   }

  //   if ($event.target.parentElement.parentElement.getElementsByClassName('active').length >= 1) {
  ...
  //     } else if ($event.currentTarget.children.length >= 1) {
  //       $event.currentTarget.getElementsByClassName('box zone-name-box')[0].className += ' active'
  //     }
  //   }
  // }